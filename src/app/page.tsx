        ...
        <section className="max-w-6xl mx-auto px-4 pb-14">
          <div className="flex items-end justify-between mb-5">
            <div>
              ...
              <h2 style={{ fontSize: "var(--text-h2)" }} className="font-display">
                Fresh off the board
              </h2>
            </div>
            <Link href="/beats" className="text-sm underline" style={{ color: "var(--accent-hot)" }}>
              See all
            </Link>
          </div>
